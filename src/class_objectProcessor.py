...
class objectProcessor(threading.Thread):
    ...
    """ 
    Defines the time in seconds by which we adjust the 'receivedtime' value when we save acknowledgment msgs
    to the database. This helps to ensure that the ack will be picked up by any lite clients that need it. 
    """
    ACK_SAVE_ADJUSTMENT_TIME = 30
    ...
    def processmsg(self, data):
        ...
        if msgData in shared.ackdataForWhichImWatching:
