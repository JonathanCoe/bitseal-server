...
''' Equals two days and 12 hours '''
maximumAgeOfObjectsThatIAdvertiseToOthers = 216000 

''' Equals three hours '''
maximumAgeOfNodesThatIAdvertiseToOthers = 10800

''' If you set this to True while on the normal network, you won't be able to send or sometimes receive messages.'''
...
def checkAndShareMsgWithPeers(data):
    ...
    inventory[inventoryHash] = (
        objectType, streamNumberAsClaimedByMsg, data, receivedTime,'')
